...
const Pandas = () => {
    ...
    <div className='w-full h-auto px-4'>
        ...
        <div className='max-w-screen-2xl mx-auto px-16'>
            ...
            <section id="pandas" className="w-full pt-8 pb-20 border-b-[1px] border-b-detail flex">
                <div className="w-1/2 flex flex-col pl-10 relative">
                    ...
                    <h2 className="text-2xl pt-2 font-semibold font-style: italic text-hover tracking-wide">Pandas Fonologiske Lege</h2>
